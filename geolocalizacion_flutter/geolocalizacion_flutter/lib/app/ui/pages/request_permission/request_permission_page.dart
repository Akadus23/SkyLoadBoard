...
import 'package:geolocalizacion_flutter/app/ui/pages/request_permission/request_permission_controller.dart';
          ...
          showDialog(
            context: context,
             builder: (_) => AlertDialog(
              ...
              content: const Text ('No se pudo recuperar el acceso a la ubicacion del dispositivo'),
              actions: [
                TextButton(
                  onPressed: () async{
